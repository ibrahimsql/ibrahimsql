...
[![My Skills](https://skillicons.dev/icons?i=cpp,arch,c,cs,go,kali,linux,py,raspberrypi,ruby,rust,bash,powershell,js,perl,vim,windows,postman,nim,vala,aws,gcp,md,obsidian,lua)](https://skillicons.dev)
